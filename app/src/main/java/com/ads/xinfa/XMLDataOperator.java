...
import com.ads.xinfa.myInterface.IDisplayType;
import com.ads.xinfa.myInterface.ImageAndVideoTypeImpl;
import com.ads.xinfa.myInterface.ImageTypeImpl;
import com.ads.xinfa.myInterface.MarqueeTypeImpl;
import com.ads.xinfa.myInterface.VideoTypeImpl;
...
//        dataString = FileManager.loadXMLFromSDCard(FileManager.XML_DATA);
        dataString = FileManager.loadXMLFromSDCard(FileManager.TEST_XML_DATA);
...
//        configString = FileManager.loadXMLFromSDCard(FileManager.TEST_XML_CONFIG);
    ...
    private void setData(){
        ...
        XinFaApplication.COMMAND_HASHMAP.clear();
        if (commandList!=null) {
            for (int i = 0; i < commandList.size(); i++) {
                ConfigBean.Commands.Command command = commandList.get(i);
                XinFaApplication.COMMAND_HASHMAP.put(command.getType(),command.getUrl());
            }
        }
    }
