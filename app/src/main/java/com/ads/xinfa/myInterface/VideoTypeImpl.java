...
import com.ads.xinfa.view.ImadeoView;

import java.io.File;

public class VideoTypeImpl extends IDisplayType {

    public VideoTypeImpl(int index,Context context) {
        super(index,context);
    }
    ...
    public ViewGroup display(MyBean.GroupsBean.GroupBean.AreasBean areas) {
        ...
        ViewGroup vg = createView(infoBean.getLeft(), infoBean.getTop(), infoBean.getWidth(), infoBean.getHeight(), files, infoBean.getVoice1(), time);
        return vg;
    }
    private ViewGroup createView(String left, String top, String width, String height,  File[] files,String volume,int[] times){
        ...
        //    Log.e(TAG, "imadeoView:    " + "x:" + x + "y:" + y + "width:" + width + "height:" + height + "path:" + Resource_DIR);
