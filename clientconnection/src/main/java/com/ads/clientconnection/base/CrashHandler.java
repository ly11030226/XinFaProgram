...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    private static final String PATH = Environment.getExternalStorageDirectory().getPath() +
            File.separator + "SZTY"+File.separator+"MyCrash"+File.separator;
...
//        }
        ...
        String time = new SimpleDateFormat("yyyy-MM-dd_HH:mm:ss").format(new Date(currenttime));

        File exfile = new File(PATH + FILE_NAME + time + FILE_NAME_SUFEIX);
        ...
        //CPU架构
        pw.println("CPU ABI:" + Build.SUPPORTED_ABIS);
