...
import com.ads.clientconnection.view.ImagePicker.PhotoSelectorActivity;
...
public class SelectPhotoItem extends LinearLayout implements OnCheckedChangeListener, OnClickListener {
    ...
    private static final String TAG = "SelectPhotoItem";
    ...
    public void setImageDrawable(final PhotoModel photo) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                try {
                    Glide.with(context).load(photo.getOriginalPath()).into(ivPhoto);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
