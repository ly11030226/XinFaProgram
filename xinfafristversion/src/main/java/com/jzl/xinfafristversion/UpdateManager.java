...
public class UpdateManager {
    ...
    public UpdateManager(Context context, String uri, Handler handler) {
...
//            Toast.makeText(mContext, R.string.soft_update_no, Toast.LENGTH_LONG).show();
    ...
    private int getVersionCode(Context context) {
        ...
        try {
            ...
            versionCode = context.getPackageManager().getPackageInfo("com.example.haoweigang.play_resource", 0).versionCode;
