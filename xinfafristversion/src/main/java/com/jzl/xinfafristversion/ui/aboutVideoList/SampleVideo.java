...
//    private TextView mChangeTransform;
    ...
    private List<MyBean.GroupsBean.GroupBean.AreasBean.AreaBean.FilesBean.FileBean> mUrlList = new ArrayList<>();
...
//                mChangeTransform.setText("旋转镜像");
     ...
     * @return
     */
    public boolean setUp(List<MyBean.GroupsBean.GroupBean.AreasBean.AreaBean.FilesBean.FileBean> entity, boolean cacheWithPlay, String title) {
        mUrlList = entity;
     ...
     * @return
     */
    public boolean setUp(List<MyBean.GroupsBean.GroupBean.AreasBean.AreaBean.FilesBean.FileBean> entity, boolean cacheWithPlay, File cachePath, String title) {
        mUrlList = entity;
